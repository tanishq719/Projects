    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_q', django.contrib.postgres.fields.ArrayField(base_field=models.BigIntegerField(blank=True, null=True), blank=True, default=groups.models.Group.default_list, null=True, size=None)),
            ],
            options={
                'db_table': 'group',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('grp_id', models.ForeignKey(db_column='grp_id', on_delete=django.db.models.deletion.CASCADE, related_name='grp_members', to='groups.Group')),
                ('user_id', models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.PROTECT, related_name='member_user_id', to='users.Users')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_q', django.contrib.postgres.fields.ArrayField(base_field=models.BigIntegerField(blank=True, null=True), blank=True, default=groups.models.Has_followers.default_list, null=True, size=None)),
                ('grp_id', models.ForeignKey(db_column='grp_id', on_delete=django.db.models.deletion.CASCADE, related_name='grp_followers', to='groups.Group')),
                ('user_id', models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, related_name='follower_user_id', to='users.Users')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.DO_NOTHING, related_name='blocked_user_id', to='users.Users')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grp_id_to', models.ForeignKey(db_column='grp_id_to', on_delete=django.db.models.deletion.DO_NOTHING, related_name='blocked_grp_id', to='groups.Group')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='group',
            name='g_blocks_g',
            field=models.ManyToManyField(blank=True, null=True, related_name='_group_g_blocks_g_+', through='groups.Grp_blocks_grp', to='groups.Group'),
        ),
        migrations.AddField(
            model_name='group',
            name='g_blocks_u',
        ...
        migrations.AddField(
            model_name='group',
            name='g_deletes_g',
            field=models.ManyToManyField(blank=True, null=True, related_name='_group_g_deletes_g_+', through='groups.Grp_deletes_grp', to='groups.Group'),
        ),
        migrations.AddField(
            model_name='group',
            name='g_followers_u',
        ...
        migrations.AddField(
            model_name='group',
            name='g_parent_id',
            field=models.ForeignKey(blank=True, db_column='g_parent_id', null=True, on_delete=django.db.models.deletion.CASCADE, to='groups.Group'),
        ),
        migrations.AddField(
            model_name='group',
            name='grp_admin',
